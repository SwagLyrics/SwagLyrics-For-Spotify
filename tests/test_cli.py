...
class Tests(unittest.TestCase):
    ...
    def test_that_stripping_works(self):
        ...
        self.assertEqual(
            stripper("Chanel (Go Get It) [feat. Gunna & Lil Baby]", "Young Thug"), "Young-Thug-Chanel-Go-Get-It"
        )
        self.assertEqual(
            stripper("MONOPOLY (with Victoria Monét)", "Ariana Grande"), "Ariana-Grande-and-Victoria-Monet-MONOPOLY"
        )
        self.assertEqual(stripper("Seasons (with Sjava & Reason)", "Mozzy"), "Mozzy-Sjava-and-Reason-Seasons")
        self.assertEqual(
            stripper("거품 안 넘치게 따라줘 [Life Is Good] (feat. Crush, Dj Friz)", "Dynamic Duo"), "Dynamic-Duo-Life-Is-Good"
        )
    ...
    def test_that_lyrics_calls_requests(self, f_get_lyrics, mock_requests):
        ...
        self.assertEqual(lyrics("Pixel2XL", "Elgoog", True), "Couldn't get lyrics for Pixel2XL by Elgoog.\n")
